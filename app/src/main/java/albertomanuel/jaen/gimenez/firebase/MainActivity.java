package albertomanuel.jaen.gimenez.firebase;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database = FirebaseDatabase.getInstance("https://fir-ejemplo-68425-default-rtdb.europe-west1.firebasedatabase.app/");
